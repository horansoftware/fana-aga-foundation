        ...
        <div class="row g-5">
          ...
          <div class="col-lg-8">
            ...
            <article class="blog-details">
              ...
              <div class="post-img">
                <img src="admin/upload/16266242_1684235581874634_7962423656264126351_n.jpg" alt="" class="img-fluid">
              </div>

              <h2 class="title">The Gada System</h2>

              <div class="meta-top">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details.html">Faana Aagaa Foundation</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="blog-details.html"><time datetime="2020-01-01"><?php echo date('Y-m-d') ?></time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="blog-details.html">100+ Views</a></li>
                </ul>
              </div><!-- End meta top -->

              <div class="content"> 
                <p> Faana Aagaa Foundation is a tribute to the legacy of Aba Gada Aagaa Xenxenoo, established with the aim of preserving and promoting the Gadaa system and its cultural heritage.  </p>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                ...
                <ul class="mt-3">
                  <li><a href="#">Gujii <span>(2)</span></a></li>
                  <li><a href="#">Culture <span>(4)</span></a></li>
                  <li><a href="#">Faana Agaa <span>(3)</span></a></li> 
